...
<h2><span style="color:#2d7eea">Spectacles 3 Layer</span></h2>
Spectacles 3 layers is the framework developed by Spectacles. The main purpose is to break lookml view into smaller files for better maintainence and traceability. Spectacles devide views & explorers into 3 layers:
...
- Model: project level configuration like the connection, caching, and access grants

For detail, refer to [Spectacles article](https://www.spectacles.dev/post/fix-your-lookml-project-structure) as guideline for implementation
